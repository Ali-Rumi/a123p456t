...
class TradingStrategy:
    ...
    def run_bnb_long(self):
        try:
            subprocess.Popen(["python", "apt_long.py"])
            print("Running apt_long.py")
        except Exception as e:
            print(f"Error running apt_long.py: {e}")

    def run_bnb_short(self):
        try:
            subprocess.Popen(["python", "apt_short.py"])
            print("Running apt_short.py")
        except Exception as e:
            print(f"Error running apt_short.py: {e}")
